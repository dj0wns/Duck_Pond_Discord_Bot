#code from https://github.com/mikeStr8s/ClassicBot
...
from constants import MAX_CHARS, ICON, LINE_HEIGHT, SMALL_PADDING, HEIGHT, DISCORD_BG, BG_COLOR, COLORS, INDENT, MONEY, TOOLTIP_FONT
...
def wrap_text(lines):
    ...
    max_line_length = drawer.textsize(max_line, TOOLTIP_FONT)[0]
